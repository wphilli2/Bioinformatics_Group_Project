...
## Usage: bash primate_loop.sh <RNAseq file to be searched> <hmm profile to search against>

for file in $1 
do
filename=$(echo $file)
/afs/nd.edu/user24/wphilli2/local/bin/hmmer/hmmsearch --tblout $filename.hits $2 $file
done
